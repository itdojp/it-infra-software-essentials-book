...
本書は [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.ja) ライセンスで公開されています。
BY（表示）/ NC（非営利）/ SA（継承）の条件に従う範囲で利用できます。商用利用はこの CC ライセンスでは許諾されないため、別途許諾が必要です。
